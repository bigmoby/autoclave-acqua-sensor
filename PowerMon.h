...
#define ADC_BITS 10 //12 for esp32 & 10 for esp8266
#define ADC_COUNTS (1 << ADC_BITS)
const float ICAL = 111.1; // default calibration factor: 90.9 for ESP32, 111.1 fro esp8266
const int powerPin = A0;  // ADC PIN for powerMon: A0 for esp8266, 36 for esp32
double filteredI = 0;
...
class CustomPowerMon : public PollingComponent, public sensor::Sensor
{
  public:
    ...
    void update() override
    {
        ...
        double dPower = Irms * 235; // Irms * volts
